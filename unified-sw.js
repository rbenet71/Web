...
// Versión: 2.3 (incluye Crono CRI v2.5.0)
...
const APP_CACHES = {
  ...
  'crono_cri': 'crono-cri-v2.5.0',  // 🔥 NUEVO: Crono CRI
  'gps': 'GPS-v1.0', 
  'damas': 'Damas-v1.0', 
...
const APP_RESOURCES = {
  ...
  // 🔥 NUEVO: CRONO CRI v2.5.0
  'crono_cri': [
    // Archivos principales
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI.html?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI.css?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Main.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_UI.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Utilidades.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Traducciones.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Storage_Pwa.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Salidas_1.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Salidas_2.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Salidas_3.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Salidas_4.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Llegadas.js?v=2.5.0',
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_js_Cuenta_Atras.js?v=2.5.0',
    
    // Recursos estáticos
    'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI_manifest.json?v=2.5.0',
...
self.addEventListener('install', event => {
  ...
  console.log(`Incluye Crono CRI v2.5.0`);
...
async function getFallbackPage(appName) {
  ...
  const cacheNames = {
    ...
    'crono_cri': 'https://rbenet71.github.io/Web/Árbitro/Crono_CRI/Crono_CRI.html?v=2.5.0', // 🔥 VERSIÓN ESPECÍFICA
...
self.addEventListener('message', event => {
  ...
  if (event.data && event.data.type === 'CHECK_APP') {
    ...
    event.ports[0]?.postMessage({
      app: detectedApp,
      version: detectedApp === 'crono_cri' ? '2.5.0' : 'N/A'
    });
  }
});
...
console.log(`🔥 Crono CRI v2.5.0 integrado`);