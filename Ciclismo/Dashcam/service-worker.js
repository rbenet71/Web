// Service Worker para Dashcam iPhone Pro v4.2.4.2
const CACHE_NAME = 'dashcam-iphone-pro-cache-v4.2.4.2';
const urlsToCache = [
    './',
    './index.html?v=4.2.4.2',
    './styles.css?v=4.2.4.2',
    './app.js?v=4.2.4.2',
    './manifest.json?v=4.2.4.2',
