// Service Worker para Dashcam iPhone Pro v4.2.4.1
const CACHE_NAME = 'dashcam-iphone-pro-cache-v4.2.4.1';
const urlsToCache = [
    './',
    './index.html?v=4.2.4.1',
    './styles.css?v=4.2.4.1',
    './app.js?v=4.2.4.1',
    './manifest.json?v=4.2.4.1',
