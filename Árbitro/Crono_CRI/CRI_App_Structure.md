...
**3.2 - Prioridad de Datos Mejorada:**
...
```javascript
{
    ...
    apellidos: String,
    chip: String,
    categoria: String,      // NUEVO 3.2
    equipo: String,         // NUEVO 3.2
    licencia: String,       // NUEVO 3.2
    horaSalida: String,
    cronoSalida: String,
...
// CAMPOS 3.2 (PENDIENTE IMPLEMENTACIÓN EN startOrderData):
...
1. ⚠️ **Implementar campos en `startOrderData`:**
   ...
   - Descomentar líneas marcadas con `// VERSIÓN 3.2`
...
---
*Documentación actualizada: Versión 3.2 - Campos nuevos activados pero no importados aún*
