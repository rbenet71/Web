...
**3.2.1 - Prioridad de Datos Mejorada:**
...
// CAMPOS 3.2.1 (PENDIENTE IMPLEMENTACIÓN EN startOrderData):
...
1. ⚠️ **Implementar campos en `startOrderData`:**
   ...
   - Descomentar líneas marcadas con `// VERSIÓN 3.2.1`
...
---
*Documentación actualizada: Versión 3.2.1 - Campos nuevos activados pero no importados aún*
