...
function setupServiceWorker() {
    console.log("🔄 Configurando ServiceWorker para Crono CRI v2.4.8...");
    ...
    if (isLocalhost || isHttps) {
        ...
        const swFile = 'Crono_CRI_ws.js?v=2.4.8';
        console.log(`📁 Registrando ServiceWorker: ${swFile}`);
        
        navigator.serviceWorker.register(swFile)
            .then(registration => {
                console.log('✅ ServiceWorker Crono CRI v2.4.8 registrado exitosamente:', registration.scope);
