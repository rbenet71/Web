...
async function createNewRace() {
    ...
    const newRace = {
        ...
        intervals: [],
        startOrder: [],
        // ⭐ NUEVO 3.5.4.1: Estructura de logos
        logos: {
...
function setupServiceWorker() {
    ...
    if (isLocalhost || isHttps) {
        ...
        const swFile = 'Crono_CRI_ws.js?v=3.7.5.1';
        console.log(`📁 Registrando ServiceWorker: ${swFile}`);
        
        navigator.serviceWorker.register(swFile)
            .then(registration => {
                console.log('✅ ServiceWorker Crono CRI v3.7.5.1 registrado exitosamente:', registration.scope);
