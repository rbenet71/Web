...
function setupServiceWorker() {
    console.log("🔄 Configurando ServiceWorker para Crono CRI v3.0.4...");
    ...
    if (isLocalhost || isHttps) {
        ...
        const swFile = 'Crono_CRI_ws.js?v=3.0.4';
        console.log(`📁 Registrando ServiceWorker: ${swFile}`);
        
        navigator.serviceWorker.register(swFile)
            .then(registration => {
                console.log('✅ ServiceWorker Crono CRI v3.0.4 registrado exitosamente:', registration.scope);
