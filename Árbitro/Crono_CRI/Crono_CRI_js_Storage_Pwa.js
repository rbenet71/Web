...
function setupServiceWorker() {
    console.log("🔄 Configurando ServiceWorker para Crono CRI v2.5.0...");
    ...
    if (isLocalhost || isHttps) {
        ...
        const swFile = 'Crono_CRI_ws.js?v=2.5.0';
        console.log(`📁 Registrando ServiceWorker: ${swFile}`);
        
        navigator.serviceWorker.register(swFile)
            .then(registration => {
                console.log('✅ ServiceWorker Crono CRI v2.5.0 registrado exitosamente:', registration.scope);
