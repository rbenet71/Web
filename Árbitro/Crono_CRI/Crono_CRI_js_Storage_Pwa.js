...
async function createNewRace() {
    ...
    const newRace = {
        ...
        intervals: [],
        startOrder: [],
        // ⭐ NUEVO 3.5.3.1: Estructura de logos
        logos: {
...
function setupServiceWorker() {
    ...
    if (isLocalhost || isHttps) {
        ...
        const swFile = 'Crono_CRI_ws.js?v=3.5.3';
        console.log(`📁 Registrando ServiceWorker: ${swFile}`);
        
        navigator.serviceWorker.register(swFile)
            .then(registration => {
                console.log('✅ ServiceWorker Crono CRI v3.5.3 registrado exitosamente:', registration.scope);
