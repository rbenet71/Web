...
function setupServiceWorker() {
    ...
    if (isLocalhost || isHttps) {
        ...
        const swFile = 'Crono_CRI_ws.js?v=3.7.2';
        console.log(`📁 Registrando ServiceWorker: ${swFile}`);
        
        navigator.serviceWorker.register(swFile)
            .then(registration => {
                console.log('✅ ServiceWorker Crono CRI v3.7.2 registrado exitosamente:', registration.scope);
