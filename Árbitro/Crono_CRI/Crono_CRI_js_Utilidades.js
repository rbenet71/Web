...
function loadJSPDFLibrary() {
    return new Promise((resolve, reject) => {
        ...
        jspdfScript.src = 'https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.2.2/jspdf.umd.min.js';
...
function generateSimpleStartOrderPDF() {
    ...
    try {
        if (typeof jspdf === 'undefined') {
            ...
            script.src = 'https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.2.2/jspdf.umd.min.js';
