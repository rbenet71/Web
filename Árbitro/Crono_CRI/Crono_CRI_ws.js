...
const CACHE_NAME = 'crono-cri-v 2.3';
const urlsToCache = [
    'Crono_CRI.html?v=2.3',
    'Crono_CRI.css?v=2.3',
    'Crono_CRI_js_Main.js?v=2.3',
    'Crono_CRI_js_Ui.js?v=2.3',
    'Crono_CRI_js_Utilidades.js?v=2.3',
    'Crono_CRI_js_Traducciones.js?v=2.3',
    'Crono_CRI_js_Storage_Pwa.js?v=2.3',
    'Crono_CRI_js_Salidas.js?v=2.3',
    'Crono_CRI_js_Llegadas.js?v=2.3',
    'Crono_CRI_js_Cuenta_Atras.js?v=2.3',
    'Crono_CRI_192x192.png',
    'Crono_CRI_512x512.png',
    'Crono_CRI_manifest.json?v=2.3',
