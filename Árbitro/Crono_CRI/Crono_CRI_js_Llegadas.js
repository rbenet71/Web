...
function initLlegadasMode() {
    ...
    // NUEVO 3.4.2: Actualizar contador inicial
    actualizarContadorLlegadas();
    
    // NUEVO 3.4.2: Actualizar estado inicial del tiempo compacto
...
function capturarLlegadaDirecta() {
    ...
    try {
        ...
        // NUEVO 3.4.2.1: Actualizar contador
        actualizarContadorLlegadas();
...
function actualizarFilaLlegada(index) {
    ...
    // NUEVO 3.3.4.2: Calcular posiciones por categoría
    ...
    // 6: POSICIÓN POR CATEGORÍA - NUEVO 3.3.4.2
...
// ============================================
// ACTUALIZAR UNA SOLA FILA CON POSICIÓN - ACTUALIZADO 3.3.4.2
// ============================================
function actualizarFilaLlegadaIndividual(index) {
    ...
    // NUEVO 3.3.4.2: Calcular posición por categoría
    const mapaPosicionesPorCategoria = calcularPosicionesPorCategoria(llegadasState.llegadas);
    const posicionCategoria = mapaPosicionesPorCategoria[llegada.id] || '';
    ...
    // POSICIÓN POR CATEGORÍA (col 7) - NUEVO 3.3.4.2
    celdas[6].textContent = posicionCategoria;
    celdas[6].className = 'posicion-categoria';
...
// ============================================
// RENDERIZADO DE TABLA CON 14 COLUMNAS (NUEVO ORDEN 3.3.4.2)
// ============================================
function renderLlegadasList() {
    ...
    llegadasState.llegadas.forEach((llegada, index) => {
        ...
        // Obtener posición por categoría (NUEVO 3.3.4.2)
        const posicionCategoria = mapaPosicionesPorCategoria[llegada.id] || '';
        ...
        <tr class="${claseFila}" data-id="${llegada.id}" data-index="${index}">
            ...
            <!-- 7. POSICIÓN POR CATEGORÍA (columna 7) - NUEVO 3.3.4.2 -->
...
function exportLlegadasToExcel() {
    ...
    const data = [
        ...
        [''],
        // VERSIÓN 3.3.4.2 - HEADER ACTUALIZADO (14 COLUMNAS - NUEVO ORDEN)
...
function exportRankingToExcel() {
    ...
    const data = [
        ...
        [''],
        // VERSIÓN 3.3.4.2 - HEADER ACTUALIZADO (NUEVO ORDEN)
...
// ============================================
// CALCULAR POSICIONES POR CATEGORÍA - NUEVO 3.3.4.2
// ============================================
...
// ============================================
// ============================================
// FUNCIÓN PARA GENERAR PDF DE CLASIFICACIÓN - ACTUALIZADO 3.3.4.2
// ============================================
function exportRankingToPDF() {
    ...
    try {
        ...
        // NUEVO 3.3.4.2: Calcular posiciones por categoría para PDF
        const mapaPosicionesPorCategoria = calcularPosicionesPorCategoria(llegadasConDiferencia);
        
        // ============================================
        // CONFIGURACIÓN DE TABLA - NUEVO ORDEN 3.3.4.2
        // ============================================
        ...
        // Array de anchos de columna (NUEVO ORDEN 3.3.4.2)
        ...
        function drawTableHeaders(startY) {
            ...
            // CABECERAS CON TRADUCCIONES (orden nuevo 3.3.4.2)
            const headers = [
                t.position || "POS",
                t.bibNumber || "DORSAL", 
                t.name || "NOMBRE",
                t.surname || "APELLIDOS",
                "POS. CAT.",  // NUEVO 3.3.4.2
        ...
        function drawDataRow(llegada, startY, rowNumber, diferenciaFormatted) {
                    ...
                    // POS. CAT. (NUEVO 3.3.4.2) - ASEGURAR QUE ES STRING
                    const posicionCategoria = mapaPosicionesPorCategoria[llegada.id] || "";
...
// ============================================
// ACTUALIZAR CONTADOR DE LLEGADAS - NUEVO 3.4.2.1 (VERSIÓN CORREGIDA)
// ============================================
